...
# render script
test_Ne <- slimr_script_render(sims,template = list(mut_rate=mut_rate),reps = replicates)
...
# render script
BGS <- slimr_script_render(sims,template = list(mut_rate=mut_rate),reps = replicates)
# run the slim scripts in parallel by defining the number of workers. Please do not use more than 2 within rcloud to save computation hours.
plan(multisession(workers = 2))
# sun simulations 
